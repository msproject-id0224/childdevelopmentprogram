                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg dark:bg-gray-800 transition-colors duration-200">
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            <div className="px-4 sm:px-0 mb-6 border-b border-gray-200 dark:border-gray-700 pb-6">
                                ...
                                <div className="flex flex-col md:flex-row md:items-start md:space-x-6 space-y-4 md:space-y-0">
                                    ...
                                    <div className="flex-grow max-w-xl">
                                        {user.profile_photo_status === 'pending' ? (
                                            ...
                                            <form onSubmit={submitPhotoRequest}>
                                                ...
                                                <InputLabel htmlFor="photo" value={__('Request Photo Update')} />
                                                <input 
                                                    type="file" 
                                                    id="photo" 
                                                ...
                                                <div className="mt-4">
                                                    <PrimaryButton disabled={photoProcessing}>{__('Submit Request')}</PrimaryButton>
                                                </div>
                                            </form>
                                        )}
                                    </div>
                            ...
                            <div className="px-4 sm:px-0 mb-6">
                                <h3 className="text-base font-semibold leading-7 text-gray-900 dark:text-gray-100">{__('Participant Information')}</h3>
                                <p className="mt-1 max-w-2xl text-sm leading-6 text-gray-500 dark:text-gray-400">{__('Personal details and membership status.')}</p>
                            </div>
